...
<head>
    ...
    <%@include file="/live/inclued_page/base_js_css.jsp" %>
    <script type="text/javascript" src="/live/video/js/jquery.colorpicker.js"></script>
    <link href="/live/video/css/mycss.css" rel="stylesheet">
    <script src="https://cdn.bootcss.com/webrtc-adapter/5.0.4/adapter.min.js"></script>
    <script type="text/javascript" src="/live/video/js/live_socket.js"></script>
    <script type="text/javascript" src="/live/video/js/web_RTC.js"></script>
    <script type="text/javascript" src="/live/video/js/send_Barrage.js"></script>
    <script type="text/javascript" src="/live/video/js/ui.js"></script>
    <script type="text/javascript" src="/live/video/js/format_date.js"></script>
    <script type="text/javascript" src="/live/video/js/full_screen.js"></script>

</head>

<body>

<%@include file="/live/inclued_page/nav.jsp" %>
<div class="content">
    <div id="video_father" style="background: url('/live/video/img/bg_live.jpg');background-repeat: no-repeat ">
        <div id="video_info">
            <div class="videoinfo">
                    <span style="text-align: center;top: 8px;left:13px;color: rgb(33, 156, 247)">
                    <i style="background: url(/live/img/icons.png) -535px -854px no-repeat;"></i>
        ...
        <div class="left_cope" style=" background: url('/live/video/img/bg_live.jpg') 0px -35px;"></div>
        <div class="center_content">
            <div class="dm">
                <div class="d_mask">
                    <video id="live_video" class="barrage_video" autoplay width="100%" height="100%" preload="auto"
                           loop controls poster="/live/video/img/zhibo.jpg">
                    </video>
            ...
            <div id="sendnav">
                ...
                <button class="fontbutton_config btn" style="border-radius:0;" id="sendcolor" type="button"
                        value="#ffffff">
                    <img src="/live/video/img/colorpicker.png" width="14" height="14">
                    字体颜色
                </button>
        ...
        <div class="right_cope" style=" background: url('/live/video/img/bg_live.jpg') -1242px -35px;"></div>
...
<%@include file="/live/inclued_page/model_login.jsp" %>
